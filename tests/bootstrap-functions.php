...
function init_test_suite( $test_suite = 'Unit' ) {
    ...
    require_once EVENTMANAGER_PLUGIN_ROOT . '/vendor/autoload.php';
    ...
    require_once EVENTMANAGER_PLUGIN_ROOT . '/vendor/antecedent/patchwork/Patchwork.php';
}
...
function init_constants( $test_suite_folder ) {
    define( 'EVENTMANAGER_PLUGIN_ROOT', dirname( __DIR__ ) . DIRECTORY_SEPARATOR );
    define( 'EVENTMANAGER_PLUGIN_TESTS_ROOT', __DIR__ . DIRECTORY_SEPARATOR . $test_suite_folder );
    if ( 'Unit' === $test_suite_folder && ! defined( 'ABSPATH' ) ) {
        define( 'ABSPATH', EVENTMANAGER_PLUGIN_ROOT );
    }
}
